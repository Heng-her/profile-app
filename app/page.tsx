    ...
    <div className="min-h-screen flex flex-col justify-between text-white selection:bg-yellow-400 selection:text-black">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 space-y-20">
        ...
        <section className="text-center space-y-6 max-w-4xl mx-auto pt-6 pointer-events-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-yellow-500/10 border border-yellow-500/30 text-yellow-400 text-xs font-mono font-bold uppercase tracking-widest shadow-lg shadow-yellow-500/10">
          ...
          {/* Quick Metrics */}
          <div className="pt-4 flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-xs sm:text-sm text-zinc-300 font-mono">
        ...
        <section className="space-y-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-white/10 pb-4 pointer-events-auto">
            ...
            <div className="text-xs font-mono text-yellow-400 bg-yellow-500/10 border border-yellow-500/30 px-3 py-1 rounded-full">
